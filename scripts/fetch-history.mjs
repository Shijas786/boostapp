...
async function main() {
    console.log('\n🔄 Fetching 7 Days of History for Tracked Tokens...\n');
    ...
    console.log('Step 1: Querying CDP for history...');
    ...
    const rows = result || [];
    console.log(`   ✅ Found ${rows.length} historical transfers\n`);
    ...
    for (let i = 0; i < rows.length; i += CHUNK_SIZE) {
        ...
        const seen = new Set();
        const buysToInsert = chunk.map(r => ({
